...
const Contact = () => {
  return (
    <section className="relative w-full flex justify-center flex-col p-5 text-black">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-evenly p-20">
        <div className="relative w-full lg:w-[500px] bg-primary p-10 rounded-md flex flex-col gap-20 overflow-hidden shadow-lg">
          ...
          <div className=" absolute bg-light dark:bg-dark -top-[7rem] -left-[6rem] w-[200px] h-[200px] rounded-full"></div>
          <div className=" absolute bg-light dark:bg-dark top-[50%] -right-[7rem] w-[200px] h-[200px] rounded-full"></div>
          <div className="absolute w-[400px] -bottom-[7rem] right-[4rem]">
            <Lottie animationData={contact} />
          </div>
          <div className=" text-[25px] h-[350px] flex flex-col gap-10 text-white">
            <h1>
